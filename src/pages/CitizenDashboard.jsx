    ...
    const communityImpact = [
        {
            ...
            description: 'The flickering light at 4th Cross Road has been repaired by KSEB',
            icon: '💡',
            color: '#FFA500'
        },
        {
            title: 'Waste cleared',
            description: 'Illegal dumping site near the park has been cleared and fenced.',
            icon: '🗑️',
            color: '#10B981'
        }
    ];
                ...
                <div className="citizen-stat-card blue">
                    <div className="stat-header">
                        <div>
                            ...
                            <div className="stat-change">+{stats.newThisMonth} New <span className="muted">THIS MONTH</span></div>
                        </div>
                ...
                <div className="citizen-stat-card green">
                    <div className="stat-header">
                        <div>
                            ...
                            <div className="stat-change">{stats.resolutionRate}% Rate <span className="muted">RESOLUTION SUCCESS</span></div>
                        </div>
                ...
                <div className="citizen-stat-card orange">
                    <div className="stat-header">
                        <div>
                            ...
                            <div className="stat-change">{stats.status} <span className="muted">AWAITING ACTION</span></div>
                        </div>
            ...
            <div className="citizen-main-grid">
                ...
                <div className="report-section">
                    <div className="report-card">
                        ...
                        <p>Spot a problem in your neighborhood? Take a photo and report it instantly to your ward member.</p>
                        <button
                    ...
                    <div className="community-impact">
                        ...
                        <p className="section-subtitle">Recent resolved issues in your ward</p>

                        <div className="impact-list">
                            {communityImpact.map((item, index) => (
                                <div key={index} className="impact-item">
                                    <div className="impact-icon" style={{ background: `${item.color}20` }}>
                        ...
                        {recentTokens.map((token, index) => (
                            <div key={index} className="token-item">
                                ...
                                <div className="token-footer">
                                    <span className={`status-badge ${token.status.toLowerCase().replace(' ', '-')}`}>
                                        {token.status === 'Solved' && '● '}
                                ...
                                <div className="report-step-content">
                                    <div className="upload-section">
                                        ...
                                        <div className="tip-box">
                                            ...
                                            <span>Tip: Ensure the location is clearly visible in the background for faster verification.</span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="details-section">
                                        ...
                                        <div className="form-group">
                                            ...
                                            <textarea
                                                ...
                                                rows="4"
                                            ></textarea>
                                            <div className="char-count">{reportData.description.length}/500 characters</div>
                                        </div>
                                    </div>
                                </div>
                            )}
                            ...
                            {reportStep === 2 && (
                                <div className="review-step government-form">
                                    <div className="form-header">
                                        ...
                                        <p className="form-subtitle" style={{ color: 'white' }}>Civic Issue Report Form</p>
                                        <p className="form-number" style={{ color: 'white' }}>Form No: CIR-2026</p>
                                    </div>
                                    ...
                                    <div className="form-body">
                                        ...
                                        <div className="form-section">
                                            ...
                                            <div className="form-field-row">
                                                ...
                                                <div className="form-field">
                                                    <label>Urgency:</label>
                                                    <span className={`urgency-tag ${reportData.urgency.toLowerCase()}`}>
                                                        {reportData.urgency}
                                                    </span>
                                                </div>
                                            </div>
                                            <div className="form-field">
                                                ...
                                                <p className="description-text">{reportData.description}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="form-section">
                                            ...
                                            <div className="form-field">
                                                ...
                                                <span>{uploadType === 'video' ? 'Video Recording' : 'Photograph'}</span>
                                            </div>
                                            {uploadPreview && (
                                                <div className="evidence-preview">
                                                    {uploadType === 'video' ? (
                                                        <video src={uploadPreview} controls className="review-media" />
                                                    ) : (
                                                        <img src={uploadPreview} alt="Evidence" className="review-media" />
                                                    )}
                                                </div>
                                            )}
                                        </div>
                                        ...
                                        <div className="form-section">
                                            ...
                                            <div className="form-field-row">
                                                <div className="form-field">
                                                    ...
                                                    <span>{reportData.latitude?.toFixed(6) || 'N/A'}</span>
                                                </div>
                                                <div className="form-field">
                                                    <label>Longitude:</label>
                                                    <span>{reportData.longitude?.toFixed(6) || 'N/A'}</span>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div className="modal-footer">
                            ...
                            {reportStep < 2 ? (
                                <button
                                    ...
                                    onClick={() => setReportStep(reportStep + 1)}
                                    disabled={!uploadedFile || !reportData.description || !reportData.location}
                                >
                                    Next
                                </button>
                            ) : (
                ...
                <div className="modal-overlay success-overlay">
                    <div className="success-modal">
                        <div className="success-animation-container">
                            ...
                            <p>Your civic issue has been registered and will be reviewed by the concerned department.</p>
                            ...
                            <div className="token-id-container">
                                ...
                                <p className="token-note">Save this ID to track your report status</p>
                            </div>

                            <div className="department-info">
                                <p><strong>Assigned Department:</strong> {reportData.detectedDepartment || 'Processing...'}</p>
                                <p><strong>Category:</strong> {reportData.detectedCategory || 'Processing...'}</p>
                            </div>
